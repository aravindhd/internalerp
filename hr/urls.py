...
urlpatterns = [
    ...
    url(r'^leavesToApprove/$', views.leaves_to_approve, name='leaves_to_approve'),
    url(r'^myempleaves/$', views.leaves_list_per_manager, name='leaves_list_per_manager'),
    url(r'^myempleavesToApprove/$', views.leaves_to_approve_per_manager, name='leaves_to_approve_per_manager'),
    ...
    url(r'^hrDataExport$', views.hr_data_export, name='hr_data_export'),
